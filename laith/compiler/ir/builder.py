...
class IRBuilder:
    ...
    def visit_Call(self, node: ast.Call) -> IRValue:
        if isinstance(node.func, ast.Name):
            ...
            ui = {"Column", "Row", "Box", "Text", "Button", "TextField", "Checkbox", "Switch", "Slider", "Image", "Icon", "Spacer", "Scaffold", "TopAppBar", "BottomAppBar", "NavigationBar", "NavigationBarItem", "FloatingActionButton", "Dialog", "AlertDialog", "Snackbar", "ModalBottomSheet"}
            is_ui = name in ui
            args = []; imms = []; kids = []
            for a in node.args:
